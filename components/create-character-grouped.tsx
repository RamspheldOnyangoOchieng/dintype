...
export default function CreateCharacterGrouped() {
    ...
    const steps = [
        'Choose Style',
        'Physical Features',  // Ethnicity, Age, Eye Color
        'Hair',                 // Hair Style, Hair Color
        'Body',               // Body Type, Breasts, Butt
        'Personality',
        'Relationship',
        'Summary',
        'Generate'
            ...
            {!user ? (
                ...
                <div className="max-w-4xl mx-auto pt-16 px-6">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold mb-2">🧬 Create My Companion</h1>
                    ...
                    <div className="flex items-center justify-between mb-8">
                        {steps.map((label, idx) => (
                            <div key={idx} className="flex items-center">
                                <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center text-sm font-bold ${idx <= currentStep ? 'bg-primary border-primary text-primary-foreground' : 'bg-secondary border-secondary text-muted-foreground'
                                    }`}>
                    ...
                    <div className="bg-card rounded-2xl p-8 shadow-2xl border border-border">
                        ...
                        {currentStep === 0 && (
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-center">Choose Style</h2>
                                <div className="flex justify-center gap-6">
                                    <div
                                        className={`cursor-pointer rounded-xl p-2 transition-all border-2 ${selectedStyle === 'realistic'
                                    ...
                                    >
                                        ...
                                        <div className="text-center mt-2">
                                            <span className="text-lg font-semibold">Realistic</span>
                                        </div>
                                    </div>
                                    <div
                                        className={`cursor-pointer rounded-xl p-2 transition-all border-2 ${selectedStyle === 'anime'
                                                ? 'bg-primary border-primary'
                                                : 'border-border hover:border-primary'
                                            }`}
                        ...
                        {currentStep === 1 && (
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-center">Physical Features</h2>

                                {/* Ethnicity */}
                                <div className="mb-8">
                                    <h3 className="text-lg font-semibold mb-4">Ethnicity *</h3>
                                    <div className="grid grid-cols-4 gap-4">
                                        {['caucasian', 'latina', 'asian', 'african', 'indian', 'arab', 'mixed'].map(eth => {
                                            ...
                                            return (
                                                <div key={eth} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.ethnicity === eth ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-4 gap-4">
                                        {[
                                            ...
                                            return (
                                                <div key={age.value} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.age === age.value ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-5 gap-4">
                                        {['brown', 'blue', 'green', 'hazel', 'gray', 'amber', 'dark-brown', 'light-blue', 'violet', 'heterochromia'].map(eye => {
                                            ...
                                            return (
                                                <div key={eye} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.eyeColor === eye ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                        ...
                        {currentStep === 2 && (
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-center">Hair</h2>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-4 gap-4">
                                        {['straight', 'wavy', 'curly', 'coily', 'braided', 'bun', 'ponytail', 'bob'].map(style => {
                                            ...
                                            return (
                                                <div key={style} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.hairStyle === style ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                                ...
                                {/* Hair Length */}
                                <div className="mb-8">
                                    <h3 className="text-lg font-semibold mb-4">Hair Length *</h3>
                                    <div className="grid grid-cols-4 gap-4">
                                        {['bald', 'buzz-cut', 'short', 'shoulder', 'mid-back', 'waist', 'hip', 'floor'].map(length => {
                                            ...
                                            return (
                                                <div key={length} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.hairLength === length ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-5 gap-4">
                                        {['black', 'dark-brown', 'brown', 'light-brown', 'blonde', 'platinum', 'red', 'auburn', 'gray', 'white'].map(color => {
                                            ...
                                            return (
                                                <div key={color} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.hairColor === color ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                        ...
                        {currentStep === 3 && (
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-center">Body</h2>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-4 gap-4">
                                        {['slim', 'athletic', 'average', 'curvy', 'chubby', 'muscular', 'cub'].map(body => {
                                            ...
                                            return (
                                                <div key={body} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.bodyType === body ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                                ...
                                {/* Eye Shape */}
                                <div className="mb-8">
                                    <h3 className="text-lg font-semibold mb-4">Eye Shape *</h3>
                                    <div className="grid grid-cols-5 gap-4">
                                        {['almond', 'round', 'upturned', 'downturned', 'hooded', 'monolid', 'deep-set', 'prominent', 'close-set', 'wide-set'].map(shape => {
                                            ...
                                            return (
                                                <div key={shape} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.eyeShape === shape ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                                ...
                                {/* Lip Shape */}
                                <div>
                                    <h3 className="text-lg font-semibold mb-4">Lip Shape *</h3>
                                    <div className="grid grid-cols-5 gap-4">
                                        {['thin', 'full', 'bow-shaped', 'heart-shaped', 'round', 'wide', 'upturned', 'downturned', 'heavy-top', 'heavy-bottom'].map(shape => {
                                            ...
                                            return (
                                                <div key={shape} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.lipShape === shape ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {['caregiver', 'sage', 'innocent', 'jester', 'temptress', 'dominant', 'submissive', 'lover', 'nympho', 'mean', 'confidant', 'experimenter'].map(p => {
                                        ...
                                        return (
                                            <div key={p} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.personality === p ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                        ...
                        {currentStep === 5 && (
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-center">Relationship</h2>
                                <div className="grid grid-cols-3 gap-4">
                                    {['stranger', 'school-mate', 'colleague', 'mentor', 'girlfriend', 'sex-friend', 'wife', 'mistress', 'friend', 'best-friend', 'step-sister', 'step-mom'].map(r => {
                                        ...
                                        return (
                                            <div key={r} className={`cursor-pointer rounded-xl p-2 border-2 transition-all ${selectedAttributes.relationship === r ? 'border-primary bg-primary/10' : 'border-border hover:border-primary'
                        ...
                        {currentStep === 6 && (
                            <div>
                                <h2 className="text-2xl font-bold mb-6 text-center">Review Your AI Companion</h2>
                                ...
                                <div className="grid grid-cols-3 gap-4 mb-8">
                                    ...
                                    {selectedAttributes.hairStyle && (
                                        <div className="text-center">
                                            ...
                                            <p className="text-xs text-muted-foreground">Hair Style</p>
                                        </div>
                                    )}
                                    ...
                                    {selectedAttributes.eyeShape && (
                                        <div className="text-center">
                                            ...
                                            <p className="text-xs text-muted-foreground">Eye Shape</p>
                                        </div>
                                    )}
                                    ...
                                    {selectedAttributes.lipShape && (
                                        <div className="text-center">
                                            ...
                                            <p className="text-xs text-muted-foreground">Lip Shape</p>
                                        </div>
                                    )}
                                ...
                                <div className="text-center mt-6">
                                    <div className="inline-block bg-primary/10 px-6 py-3 rounded-lg border-2 border-primary">
                                        <strong className="text-primary">Style:</strong> <span className="capitalize">{selectedStyle === 'realistic' ? 'Realistic' : 'Anime'}</span>
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        {currentStep === 7 && (
                            <div>
                                {isGenerating ? (
                                    <div className="text-center">
                                        <h2 className="text-3xl font-bold mb-4">Creating Your AI</h2>
                                        <div className="flex justify-center items-center mb-8">
                                            <div className="w-32 h-32 border-4 border-border rounded-full animate-spin border-t-primary"></div>
                                        </div>
                                        <p className="text-lg text-muted-foreground">Generating your character...</p>
                                    </div>
                                ) : generatedImageUrl ? (
                                    <div className="text-center">
                                        <h2 className="text-3xl font-bold mb-4">Your AI is Ready!</h2>
                                        ...
                                        {showNameDialog && (
                                            <div className="max-w-md mx-auto bg-card p-6 rounded-xl border-2 border-border shadow-xl">
                                                <h3 className="text-xl font-bold mb-4 text-center">Name Your Character</h3>
                                                <div className="mb-4 p-3 bg-primary/10 rounded-lg text-sm text-center">
                                                    <p className="text-muted-foreground">
                                                        💰 <span className="font-semibold">Cost:</span> 2 tokens
                                                        <br />
                                                        <span className="text-xs">(Includes AI description generation)</span>
                                                    </p>
                                                </div>
                                                <input
                                                    type="text"
                                                ...
                                                <p className="text-sm text-muted-foreground text-center mt-3">Press Enter to start chatting</p>
                                            </div>
                                        )}
                                    </div>
                                ) : null}
                        ...
                        <div className="flex justify-between mt-8">
                            ...
                            >
                                {currentStep === 6 ? 'Generate Character →' : 'Next →'}
                            </button>
                        </div>
                    </div>
                </div>
