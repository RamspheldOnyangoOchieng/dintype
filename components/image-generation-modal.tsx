...
export function ImageGenerationModal({ isOpen, onClose, onImageSelect, trigger }: ImageGenerationModalProps) {
  ...
  const backgroundOptions = [
    ...
    { value: "beach", label: "Tropical Beach" },
    { value: "ocean", label: "Deep Sea" },
    { value: "mountains", label: "Majestic Mountains" },
    { value: "bedroom", label: "Bedroom" },
    { value: "shop", label: "Luxury Shop" },
    { value: "kitchen", label: "Modern Kitchen" },
    { value: "lodge", label: "Rustic Lodge" },
    { value: "fuck_room", label: "Intimate Room" },
