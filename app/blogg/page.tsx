                    ...
                    <div className="bg-card border rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                      {post.featured_image && (
                        <div className="relative h-56 overflow-hidden bg-muted">
                          <Image
                            ...
                            alt={post.title_en || post.title_sv}
                            fill
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        <div className="flex items-center gap-4 text-xs text-muted-foreground mb-3">
                          ...
                          {post.blog_categories && <span>• {post.blog_categories.name_en || post.blog_categories.name_sv}</span>}
                        </div>

                        <h3 className="text-lg font-bold mb-3 group-hover:text-primary transition-colors line-clamp-2 min-h-[3.5rem] text-zinc-800 dark:text-white">
                          {post.title_en || post.title_sv}
                        </h3>

                        <p className="text-muted-foreground text-sm mb-4 line-clamp-3 flex-grow">
                          {post.excerpt_en || post.excerpt_sv}
                        </p>
