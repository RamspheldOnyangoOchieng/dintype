...
export default function ContactPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-4xl font-bold mb-8 text-zinc-800 dark:text-white">Pocketlove Support: We are here to help!</h1>

      <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
        <p className="text-xl leading-relaxed">
          At Pocketlove, we strive to provide you with a smooth, enjoyable, and hassle-free experience. Our dedicated customer support team is here to assist you with any questions, concerns, or technical issues you may encounter. We aim to provide professional, confidential, and impartial assistance to ensure your satisfaction.
        </p>
        ...
        <section>
          ...
          <div className="space-y-6 mt-6">
            <div className="bg-muted/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-zinc-800 dark:text-white">Account and Profile Help:</h3>
            ...
            <div className="bg-muted/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-zinc-800 dark:text-white">Technical Support:</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="bg-muted/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-zinc-800 dark:text-white">Billing and Payment Questions:</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="bg-muted/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-zinc-800 dark:text-white">Content and Community Guidelines:</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="bg-muted/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-zinc-800 dark:text-white">Feature Explanations and Usage:</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>Providing information on how to use specific features of Pocketlove (e.g., AI character creation, image generation, chat features)</li>
        ...
        <section>
          ...
          <div className="space-y-6 mt-6">
            <div className="border border-border p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-zinc-800 dark:text-white">📧 Email</h3>
              <p>
                For detailed inquiries or when you need to send attachments, please email us at{" "}
                <a href="mailto:support@pocketlove.ai" className="text-primary hover:underline font-semibold">
            ...
            <div className="border border-border p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-zinc-800 dark:text-white">❓ Help Center/FAQ</h3>
              <p>
                Before contacting us directly, we encourage you to browse through our comprehensive <a href="/faq" className="text-primary hover:underline">Help Center or Frequently Asked Questions (FAQ) section</a>. You can quickly and easily find the answer to your question here. This resource covers common topics and provides troubleshooting guides.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <h2 className="text-3xl font-semibold mt-12 mb-6 text-zinc-800 dark:text-white">What to expect when contacting support</h2>
        ...
        <section className="mt-12 text-center bg-gradient-to-br from-primary/20 to-primary/10 p-8 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4 text-zinc-800 dark:text-white">Ready to get started?</h2>
          <p className="mb-6 text-muted-foreground">
            Thank you for being part of the Pocketlove community. We are here to help you get the most out of your experience!
          </p>
          <a
