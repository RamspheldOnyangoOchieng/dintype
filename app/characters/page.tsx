  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white/5 p-8 rounded-[2rem] border border-white/10 mb-8 backdrop-blur-xl">
        <div>
          <h1 className="text-4xl font-black text-white tracking-tighter italic">All Characters</h1>
          <p className="text-white/40 text-sm font-medium mt-1">Explore public characters and manage your own.</p>
        </div>
