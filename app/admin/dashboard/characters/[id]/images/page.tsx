...
export default function CharacterImagesPage() {
    ...
    const handleToggleCarousel = async (img: GalleryImage) => {
        ...
        if (isInCarousel) {
            ...
            try {
                const response = await fetch(`/api/character-carousel/${characterId}`, {
                    ...
                    body: JSON.stringify({ id: isInCarousel.id })
                })
                if (response.ok) {
                ...
                toast.error("Error removing from carousel")
            }
        } else {
            // Add to carousel
            try {
                ...
                toast.error("Error adding to carousel")
            }
        }
    }
