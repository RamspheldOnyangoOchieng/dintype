...
const DEFAULT_NEGATIVE_PROMPT_PARTS = [
  "ugly, deformed, disfigured, mutated, extra limbs, fused fingers, extra fingers, mutated hands, bad anatomy, malformed, blurry, jpeg artifacts, lowres, pixelated, out of frame, watermarks, signature, censored, distortion, grain",
  ...
  "distorted eyes, asymmetrical eyes, iris distortion, pupils malformed, bloodshot eyes, cross-eyed, plastic skin, plastic clothing, glossy plastic fabric, CG fabric, shiny synthetic fabric, fused clothing, unreal fabric, badly fitted bikini, fused body and clothes, floating clouds, distorted bikini, missing nipples, bad anatomy genitals, hands covering breasts, hands on chest, generic sexy pose, hand-breast bias, extra fingers, mutated hands, malformed hands, fused fingers, missing fingers, extra limbs, extra digit, fewer digits, finger webbing, melted hands, claw-like hands",
