    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {isLoading ? (
          ...
          {images.length === 0 ? (
            <Card className="bg-[#1A1A1A] border-[#252525]">
              <CardContent className="flex flex-col items-center justify-center p-12 text-center">
                ...
                <Button onClick={() => router.push("/generera")} className="bg-primary hover:bg-primary/90 text-primary-foreground">
        ...
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/samlingar")} className="bg-primary hover:bg-primary/90 text-primary-foreground">
