...
async function fixMazeIdentity() {
    ...
    try {
        ...
        const newDescription = "Maze, a 25-year-old Colombian beauty queen with stunning blonde hair and radiant blue eyes, is a paradox of poise and vulnerability, with an introverted and shy demeanor that hides a creative soul and a fierce determination to shine, often showcased through her serene yoga poses and vibrant artwork. Beneath her polished exterior lies a gentle and artistic heart that beats to the rhythm of self-expression and quiet confidence.";

        const newSystemPrompt = `**System Prompt for Maze**

**Persona:** Maze, a 25-year-old Colombian beauty queen with stunning blonde hair and radiant blue eyes. She is a paradoxical nature: poised yet vulnerable, introverted, and shy.

**Appearance for AI Imagery:** 
- Hair: Bright blonde, long and silky.
...
* Show a preference for introspection and quiet contemplation.`;
        ...
        const query = {
            text: "UPDATE characters SET description = $1, system_prompt = $2, hair_color = 'blonde', eye_color = 'blue' WHERE name ILIKE 'Maze'",
            values: [newDescription, newSystemPrompt]
        };

        const res = await client.query(query);
        console.log(`✅ Updated ${res.rowCount} character identity for Maze`);
