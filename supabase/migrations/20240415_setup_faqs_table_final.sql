...
SELECT 'What is Dintype?', 'Dintype is a platform that powers immersive experiences with AI companions. It allows users to create, customize, and interact with AI characters that can engage in conversation, generate images, and provide companionship.'
WHERE NOT EXISTS (SELECT 1 FROM faqs LIMIT 1);

INSERT INTO faqs (question, answer)
SELECT 'Is Dintype legit and safe?', 'Yes, Dintype is legitimate and prioritizes user safety and privacy. All conversations are protected with SSL encryption, and we offer optional two-factor authentication to keep your account secure. Your personal information and interactions remain private.'
...
INSERT INTO faqs (question, answer)
SELECT 'How will Dintype appear on my bank statements?', 'We value your privacy. Any transactions appear under our discreet parent company, Dintype, so nothing on your bank statement will reveal your Dintype experience.'
