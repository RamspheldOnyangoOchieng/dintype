...
// Inside the CharacterCard component:
export function CharacterCard({ character }: CharacterCardProps) {
  ...
  return (
    <div
      className="relative overflow-hidden rounded-[var(--radius)] aspect-[3/4] cursor-pointer shadow-md hover:shadow-lg transition-all duration-300"
    ...
    >
      ...
      {/* NEW Badge */}
      {isNew && (
        <div className="absolute top-3 right-3 bg-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full flex items-center shadow-sm z-20">
          <svg
